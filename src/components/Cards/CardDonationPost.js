const CardDonationPost = ({ donationPost, handelDelete, toggleModel }) => {
    return (
        <div key={donationPost.id} className="">
            <div className="relative container flex overflow-hidden flex-wrap justify-between flex-col lg:flex-row mx-auto bg-white text-gray-500 shadow-lg mb-6 rounded-xl">
                <img
                    className="bg-white bg-center aspect-5/3  object-cover lg:w-1/3 "
                    src={donationPost.image}
                    alt=""
                />
                <div className="flex flex-col p-6 lg:p-10 lg:w-2/3">
                    <div className="">
                        ...
                        <div className="absolute top-6 right-6 flex items-center justify-end px-3 py-2 ">
                            <button
                    ...
                    <p className="flex-1 pt-2 min-h-16 mb-5">
                        {donationPost.description}
                    </p>

                    <div className="flex flex-col lg:flex-row  lg:items-center lg:justify-between pt-2">
                        <div className="flex flex-col justify-start mb-3">
                            <div class="flex items-center text-gray-400 dark:text-gray-200">
                                <i class="text-secondary-green fa-solid fa-location-dot m-1"></i>
                                <h1 class="px-2  font-medium">
                                    {donationPost.city}
                                </h1>
                            </div>
                            <div class="flex items-center mt-2 text-gray-400 dark:text-gray-200">
                                <i class="text-secondary-green fa-solid fa-clock-rotate-left m-1"></i>
                                <div className="flex flex-col lg:flex-row">
                                    <h1 class="px-2 font-medium">{`from : ${donationPost.start_date}`}</h1>
                                    <p className="px-2 font-medium text-secondary-green hidden lg:block">
                                        |
                                    </p>
                                    <h1 class="px-2 font-medium">{`to : ${donationPost.end_date} `}</h1>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col justify-between px-8 py-4 lg:w-1/3 border border-base-green cursor-pointer rounded-xl">
                            ...
                            <progress
                                class="progress progress-success w-full m-auto mt-3"
